        ...
        <v-row class="mt-3" justify="center" :class="$vuetify.breakpoint.smAndDown ? 'ml-n4 mr-n5': ''">
            <v-col cols="12" md="8">
                <v-alert type="info" border="left">
                    Please note that another admin has to authorize this process before the new admin can log into the system.
                </v-alert>
                <v-card light raised elevation="8" min-height="200">
                    <v-card-title class="subtitle-1 primary white--text justify-center">Create New SuperUser (Admin)</v-card-title>
